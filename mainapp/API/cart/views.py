...
from ...utils.utils import get_or_create_customer
...
class CartViewSet(ModelViewSet):
    ...
    def product_add_to_cart(self, *args, **kwargs):
        ...
        if created:
            ...
            cart.save()
            return Response({'productId': product.id, "detail": "Товар добавлен в корзину", "added": True})
        return Response({'productId': product.id, 'detail': "Товар уже в корзине", "added": False},
